...
if (!empty($manufacturerid)) {
    ...
    if ($total_items > 0) {
        ...
        //if page mode display mens womens change manufacturers array to reflect the correct list of links.
